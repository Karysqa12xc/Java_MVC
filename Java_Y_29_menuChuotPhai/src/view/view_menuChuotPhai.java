...
public class view_menuChuotPhai extends JFrame {
	...
	public void init() {
		...
		jButton_rename.setToolTipText("Nhấp vào đây để đổi tến");//Gáº¯n gá»£i Ã½ chá»‰ dáº«n cho button
		jButton_rename.addActionListener(ac);
		JButton jButton_copy = new JButton("Copy");
		jButton_copy.setToolTipText("Nhấp vào đây để  copy");//Gáº¯n gá»£i Ã½ chá»‰ dáº«n cho button
		jButton_copy.addActionListener(ac);
		JButton jButton_paste = new JButton("paste");
		jButton_paste.setToolTipText("Nhấp vào đây để Paste");//Gáº¯n gá»£i Ã½ chá»‰ dáº«n cho button
