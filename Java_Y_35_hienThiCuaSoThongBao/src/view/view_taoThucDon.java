...
public class view_taoThucDon extends JFrame{
	...
	public void init() {
		...
		//CÃƒÂ¡c mÃƒÂ³n Ã„Æ’n chÃƒÂ­nh cÃ¡Â»Â§a nhÃƒÂ  hÃƒÂ ng
		...
		//NÃ†Â¡i nhÃƒÂ³m cÃƒÂ¡c Radio Buttons
	...
	public void hienThiKetQua() {
		String ketQua = "Món chính: " + mttd.getLuaChon_monChinh() + 
				" Món phụ: "  + mttd.getLuaChon_monPhu() +
				" Check: " + this.mttd.getTongTien();
